...
def get_scheduler(optimizer, gamma=0.98, min_lr=1e-5):
    lr_lambda = lambda _epoch: max(gamma**_epoch, min_lr)
...
def create_optimizer(opt, model, lr, weight_decay=None, get_num_layer=None, get_layer_scale=None):
    opt_lower = opt.lower()
