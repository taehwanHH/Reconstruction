...
# 1) pretrained ResNet20 불러오기
pretrained_resnet20 = torch.hub.load(
...
class ResNet20Encoder(nn.Module):
    def __init__(self, latent_dim=128):
        ...
        # CIFAR ResNet20 은 layer1, layer2, layer3 까지 있고 avgpool
...
class ResNet20Decoder(nn.Module):
    def __init__(self, latent_dim=128, drop_p=0.2):
        ...
        self.up1 = nn.Sequential(
            nn.Upsample(scale_factor=2, mode='nearest'),  # → [B,64,8,8]
        ...
        self.up2 = nn.Sequential(
            nn.Upsample(scale_factor=2, mode='nearest'),  # → [B,32,16,16]
        ...
        self.up3 = nn.Sequential(
            nn.Upsample(scale_factor=2, mode='nearest'),  # → [B,16,32,32]
